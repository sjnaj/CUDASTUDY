...
void run()
{
    ...
    else
    {
        ...
        ITensor *inputTensor = network->addInput("inputT0", DataType::kFLOAT, Dims32 {3, {-1, -1, -1}});// -1 can be used as a wildcard for a dimension to be specified at runtime
        
        //dynamic dimensions
        //The minimum and maximum specify the permitted range that is supported at runtime, while the optimum value is used for the kernel selection. 
