...
with open("/home/fengsc/cuda-samples-11.6/parallelprogrammingbook/chapter6/1NN_classification/data/X.bin", "wb") as f:
    images = np.vstack((X, testX))
    print(images.shape)
    f.write(ar.array("f", images.flatten()))

with open("/home/fengsc/cuda-samples-11.6/parallelprogrammingbook/chapter6/1NN_classification/data/Y.bin", "wb") as f:
